    ...
    def blueprint(self, on_new_message):
        ...
        async def handle_message(sid, data):
            ...
            if data['message'] == "/get_started":
                ...
                ##receive audio
                received_file = 'audios/output_'+sid+'.wav'

                urllib.request.urlretrieve(data['message'], received_file)
                path = os.path.dirname(__file__)
                wav = sr.AudioFile(received_file) # formati riconosciuti: .aiff .flac .wav
                ...
                try:
                    message = recognizer_instance.recognize_google(audio, language="en-US")
